...
# See "Target-specific Variable Values" in the GNU Make manual.""")
  ...
  def ComputeOutputBasename(self, spec):
    ...
    if self.flavor == 'ios' and self.type in (
  ...
  def _InstallImmediately(self):
    return self.toolset == 'target' and self.flavor == 'ios' and self.type in (
          'static_library', 'executable', 'shared_library', 'loadable_module')
  ...
  def WriteTarget(self, spec, configs, deps, link_deps, bundle_deps,
    ...
    if self.type == 'executable':
      ...
      if (self.flavor not in ('ios', 'openbsd', 'netbsd', 'win') and not
    ...
    if (self.type in self._INSTALLABLE_TARGETS or
      ...
      if (self.flavor == 'ios' and not 'product_dir' in spec and
          self.toolset == 'target'):
  ...
  def _InstallableTargetInstallPath(self):
    ...
    if (self.type == 'shared_library' and
        (self.flavor != 'ios' or self.toolset != 'target')):
