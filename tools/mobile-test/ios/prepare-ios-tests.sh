...
FILES_TO_DELETE=(
  "$NODEJS_BASE_DIR/test/fixtures/wasi/subdir/input_link.txt"
  "$NODEJS_BASE_DIR/test/fixtures/wasi/subdir/loop1"
  "$NODEJS_BASE_DIR/test/fixtures/wasi/subdir/loop2"
  "$NODEJS_BASE_DIR/test/fixtures/wasi/subdir/outside.txt"
)
